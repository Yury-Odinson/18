...
export const ButtonsComponent = () => {
    ...
    const handlerLoad = () => requestData("https://mdn.github.io/learning-area/javascript/oojs/json/superheroes.json");
    ...
    return (
        <div className="main-menu-buttons">
            ...
            <button className="main-menu-buttons__item" onClick={() => handlerLoad()}>Загрузить</button>
            <button className="main-menu-buttons__item" onClick={() => handlerSaveSources()}>Сохранить</button>
            <button className="main-menu-buttons__item">Рассчитать</button>
        </div>
    )
};
